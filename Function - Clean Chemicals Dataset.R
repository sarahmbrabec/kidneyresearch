#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#~  FUNCTION - CLEANING THE CHEMICAL DATASET AND FORMING THE CLEAN CHEMICALS, WEIGHTS, AND COMMENTS DATASETS ~#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#

# Purpose: This function will clean the chemicals dataset by eliminating biomarkers that are not indicative 
#          of chemical exposures. It will also form the weights and comments dataset
# Inputs: unclean_chemical_dataset - the dataset that contains excess variables. This should be the result 
...
# Outputs: return a list that a dataframe each for the chemicals, weights, and comments dataset
